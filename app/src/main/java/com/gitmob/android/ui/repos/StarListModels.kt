...
fun JSONObject.toStarredRepo(): StarredRepo? {
    ...
    return StarredRepo(
        ...
        name           = optString("name"),
        description    = optString("description").takeIf { it.isNotBlank() && it != "null" },
        homepage       = optString("homepageUrl").takeIf { it.isNotBlank() && it != "null" },
        topics         = topics,
        isPrivate      = optBoolean("isPrivate"),
        url            = optString("url"),
        ...
        pushedAt       = optString("pushedAt").takeIf { it.isNotBlank() && it != "null" },
        ...
        mirrorUrl      = optString("mirrorUrl").takeIf { it.isNotBlank() && it != "null" },
        listIds        = listIds,
